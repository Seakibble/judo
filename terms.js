const judoTerms = {
    ...
    barai: { name: 'sweeping (sometimes spelled harai)'},
    ...
    garami: { name: 'lock'},
    gari: { name: 'reaping'},
    gatame: { name: 'hold, lock (sometimes spelled katame)'},
    goshi: { name: 'hip'},
    guruma: { name: 'wheel'},
    gyaku: { name: 'reverse'},
    'gyaku ebi': { name: 'reverse shrimp'},
    go: { name: 'five'},
    gi: { name: 'uniform'},
    ...
    harai: { name: 'sweeping (sometimes spelled barai)'},
    hiji: { name: 'elbow'},
    hiza: { name: 'knee'},
    hachi: { name: 'eight'},
    ...
    juji: { name: 'cross'},
    judo: { name: 'the gentle way, the way of non resistance'},
    juu: { name: 'ten'},
    ...
    kesa: { name: 'scarf'},
    kibisu: { name: 'heel'},
    'ki': { name: 'spirit, energy, inner stength'},
    'ki-ai': { name: 'to gather spirit with a shout'},
    ko: { name: 'small, minor' },
    koshi: { name: 'hip (sometimes spelled koshi)' },
    komi: { name: 'pulling'},
    kubi: { name: 'neck' },
    ...
    'nage-waza': { name: 'throwing techniques: comprises te-waza, koshi-waza, ashi-waza, ma-sutemi-waza, and yoko-sutemi-waza' },
    ni: { name: 'two'},

    o: { name: 'big, full, great, major'},
    obi: { name: 'belt'},
    okuri: { name: 'sliding'},
    ...
    sankaku: { name: 'triangle'},
    san: { name: 'three'},
    sensei: { name: 'teacher'},
    'sensei ni rei': { name: 'bow to teachers'},
    sesae: { name: 'propping'},
    ...
    'shomen ni rei': { name: 'bow to dojo'},
    sukui: { name: 'scooping'},
    ...
    tai: { name: 'body'},
    tomoe: { name: 'circle'},
    tsuri: { name: 'lifting (literally fishing, as in the lifting motion made when when fishing)' },
    tsurikomi: { name: 'lifting-and-pulling'},
    tsubame: {name: 'swallow'},
    tori: { name: 'executing partner, attacker'},
    tsukuri: { name: 'entry' },
    ...
    uke: { name: 'receiving partner, defender'},
    ura: { name: 'rear, back'},
    utsuri: { name: 'shift'},
